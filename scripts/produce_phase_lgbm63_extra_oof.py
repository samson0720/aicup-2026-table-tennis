"""Phase-specific LGBM with 63 leaves + another_data augmentation OOF + test parquets.

Combines phase splitting, 63 leaves (higher capacity than phase_lgbm_extra's 31),
and another_data augmentation. Writes:
  artifacts/oof/phase_lgbm63_extra_{action,point,server}.parquet  (+test)

Usage:
  conda run -n aicup-tt python -m scripts.produce_phase_lgbm63_extra_oof
"""
