...
BASES = {
    "action": ["lgbm15", "lgbm31", "markov", "phase_lgbm", "chain_action", "cat", "markovp", "markovpt", "lgbm15_extra", "lgbm31_extra", "shuttle_extra", "cat_extra", "xgb_extra"],
    "point": ["lgbm15", "lgbm31", "markov", "phase_lgbm", "chain_point", "cat", "markovp", "markovpt", "lgbm15_extra", "lgbm31_extra", "shuttle_extra", "cat_extra", "xgb_extra"],
    "server": ["lgbm15", "lgbm31", "markov", "phase_lgbm", "chain_server", "cat", "lgbm15_extra", "lgbm31_extra", "cat_extra", "xgb_extra"],
}
