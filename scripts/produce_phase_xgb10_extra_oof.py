"""Phase-specific XGBoost (max_depth=10) + another_data OOF + test parquets (GPU).

Pushes depth beyond phase_xgb8_extra (depth=8) to test if even deeper trees help.
Writes: artifacts/oof/phase_xgb10_extra_{action,point,server}.parquet  (+test)

Usage:
  CUDA_VISIBLE_DEVICES=0 conda run -n aicup-tt python -m scripts.produce_phase_xgb10_extra_oof
"""
